...
function buildEmail(lead) {
  ...
  const text = [
    ...
    "",
    "Attached (two PDFs):",
    "1. Financial summary. T12 revenue, expense detail, the actuals-based underwriting, a cap-rate reference table, the 2025 appraisals and the 2026 assessed value.",
    ...
    "",
    "I am a Texas real estate license holder selling my own property (Prestige Rental LLC).",
    "",
  ...
  const html = [
    ...
    "<ol>",
    "<li><strong>Financial summary.</strong> T12 revenue, expense detail, the actuals-based underwriting, a cap-rate reference table, the 2025 appraisals and the 2026 assessed value.</li>",
    ...
    "</ol>",
    "<p>I am a Texas real estate license holder selling my own property (Prestige Rental LLC).</p>",
